...
namespace AidCare_The_Last_Aid.Migrations
{
    ...
    [Migration("20220615230545_views for tests")]
    partial class viewsfortests
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AidCare_The_Last_Aid.Areas.Identity.Data.AidCareUser", b =>
                {
            ...
            modelBuilder.Entity("AidCare_The_Last_Aid.Models.donation", b =>
                {
            ...
            modelBuilder.Entity("AidCare_The_Last_Aid.Models.memberevent", b =>
                {
            ...
            modelBuilder.Entity("AidCare_The_Last_Aid.Models.membertest", b =>
                {
                    b.Property<int>("membertestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("membertestId"), 1L, 1);
            ...
            modelBuilder.Entity("AidCare_The_Last_Aid.Models.donation", b =>
                {
                    b.HasOne("AidCare_The_Last_Aid.Models.member", "member")
                        .WithMany("donations")
            ...
            modelBuilder.Entity("AidCare_The_Last_Aid.Models.memberevent", b =>
                {
                    b.HasOne("AidCare_The_Last_Aid.Models.Event", "Event")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AidCare_The_Last_Aid.Areas.Identity.Data.AidCareUser", null)
                        .WithMany()
